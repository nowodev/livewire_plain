<div>
  ...
  <input wire:model.defer="searchText" type="text"
         class="shadow appearance-none border rounded py-2 px-3 text-gray-700 lead mb-5">
  <br>
  ...
  <button wire:click="$emit('searchBtnWasClicked', 5)" class="bg-gray-500 rounded text-white px-3 py-2">Search</button>

  <br>

  {{ $searchText }}

  {{--  hide all other buttons on click--}}
  <button wire:click="$emit('hideButton')" class="bg-gray-500 rounded text-white px-3 py-2">Hide Button</button>
